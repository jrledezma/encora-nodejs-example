...
import { ClientWayOfEntriesService } from '../services';
import { ServiceResultInterface } from '../interfaces/service-result.interface';
import { ClientWayOfEntryModelInterface } from '../interfaces/models';

@controller(ConstantValues.clientwayofentries)
export class ClientWayOfEntriesController implements interfaces.Controller {
  private dataSrv: ClientWayOfEntriesService;

  public constructor(
    @inject(ApiTypes.clientWayOfEntrieService)
    dataSrv: ClientWayOfEntriesService
  ) {
