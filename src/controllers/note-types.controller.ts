...
import { NoteTypesService } from '../services';
import { ServiceResultInterface } from '../interfaces/service-result.interface';

@controller(ConstantValues.notetypes)
export class NoteTypesController implements interfaces.Controller {
  private dataSrv: NoteTypesService;

  public constructor(
    @inject(ApiTypes.noteTypesService)
    dataSrv: NoteTypesService
  ) {
