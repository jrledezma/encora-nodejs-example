...
@controller(ConstantValues.projectstatuses)
export class ProjectStatusesController implements interfaces.Controller {
  private dataSrv: ProjectStatusesService;

  public constructor(
    @inject(ApiTypes.projectStatusesService) dataSrv: ProjectStatusesService
  ) {
