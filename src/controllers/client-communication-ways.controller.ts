...
import { ClientCommunicationWaysService } from '../services';
import { ServiceResultInterface } from '../interfaces/service-result.interface';
import { ClientWayOfEntryModelInterface } from '../interfaces/models';

@controller(ConstantValues.clientcommunicationways)
export class ClientCommunicationWaysController implements interfaces.Controller {
  private dataSrv: ClientCommunicationWaysService;

  public constructor(
    @inject(ApiTypes.clientCommunicationWaysService)
    dataSrv: ClientCommunicationWaysService
  ) {
