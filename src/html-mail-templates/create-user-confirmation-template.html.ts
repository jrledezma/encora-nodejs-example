			...
			<tr>
				<td style="width: 100%; padding: 0.35rem !important">
					<p style="margin-bottom: 15px">
						Te comunicamos que {{fullUserName}} te ha invitado a ser parte del
						seguimiento de uno de sus clientes, ingresa a
						<a
							style="text-decoration: none !important; color: #fc6625; cursor: pointer"
							href="{{userConfirmationURL}}"
							>este enlace</a
						>&nbsp;para ser parte de su equipo de trabajo y aceptar su
						invitación
					</p>
				</td>
			</tr>
