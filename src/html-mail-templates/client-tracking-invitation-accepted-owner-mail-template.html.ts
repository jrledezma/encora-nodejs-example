        ...
        background-color: #f9f9f9 !important;">
					<h1>
						<img
							...
							"
						/>&nbsp;Nuevo Interesado en un Seguimiento
					</h1>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 100%; padding: 0.35rem !important">
					<p>
						Te informamos que {{stakeholderFullName}} ha aceptado ser parte de los interasados para uno de tus seguimientos relacionado con el cliente {{companyName}}.
					</p>
					<p>
						La invitación fue enviada por {{invitedByFullName}} en la fecha {{invitationDate}}.
					</p>
