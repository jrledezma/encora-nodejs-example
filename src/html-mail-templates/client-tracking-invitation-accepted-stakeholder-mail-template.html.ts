	...
	<body style="margin: 0; padding: 0">
        ...
        background-color: #f9f9f9 !important;">
			...
			<tr>
				<td style="width: 100%; padding: 0.35rem !important">
					<p>
						Te informamos que {{stakeholderFullName}} ha aceptado tu invitación ser parte de los interasados para uno de tus seguimientos relacionado con el cliente {{companyName}}..
					</p>
