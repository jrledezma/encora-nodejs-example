					...
					<p style="margin-bottom: 15px">
						...
						<a
							style="
								...
								margin-bottom: 10px;
							"
							href="{{recoveryPasswordURL}}"
							>este enlace </a
						>para recuperar su contraseña.
					</p>
					<p style="margin-bottom: 15px; font-size: 14px;color:#4f4f4f">
						<small style="color: #fc6625">*</small>&nbsp;El enlace tiene una hora de duración, pasado ese tiempo deberás
						volver a solicitar la recuperación de tu contraseña.
					</p>
				</td>
			</tr>
			<tr>
